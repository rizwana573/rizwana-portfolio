export default function DownArrow({ fill = "currentColor", className = "" }) {
  return (
    <svg
      ...
      height="44"
      viewBox="0 0 100 100"
      className="absolute rotate-90 left-1/2 -translate-x-1/2 top-7 group-hover:top-12 ease-in-out duration-100 arrowIcon"
    >
